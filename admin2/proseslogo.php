...
if (!$uploadfile) { 
	...
	$queryfoto = $akdb->dbquery("UPDATE "._TBPROFIL." SET `logo`='".$dest_file."' WHERE id_pf=".$_POST['cid_pf']."");
}	
//thumnailfoto

//tampilkan file hasil upload
echo '<div class="res-box">File Logo Baru <b>'.$nama_file.'</b> Berhasil Di Upload.</div>';
echo '<div class="res-box"><img src="'._URLWEB.'up/web/'.$dest_file.'" alt="file upload"></div>';
