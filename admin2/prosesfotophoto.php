...
if (!$uploadfile) { 
	...
	$queryfoto = $akdb->dbquery("UPDATE "._TBFOTO." SET `foto`='".$dest_file."',`cfoto`='".$cname."',`tgl_jam`='".date("Y-m-d H:i:s")."' WHERE id_ft=".$_POST['cid_ft']."");
}	
//thumnailfoto

//tampilkan file hasil upload
echo '<div class="res-box">File Foto Baru <b>'.$nama_file.'</b> Berhasil Di Upload.</div>';
echo '<div class="res-box"><img src="'._URLWEB.'up/foto/'.$dest_file.'" alt="file upload"></div>';
