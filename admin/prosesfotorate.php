...
if (!$uploadfile) { 
	...
	$queryfoto = $akdb->dbquery("UPDATE "._TBRATE." SET `foto`='".$dest_file."',`tgl_jam`='".date("Y-m-d H:i:s")."' WHERE id_rt=".$_POST['cid_rt']."");
}	
//thumnailfoto

//tampilkan file hasil upload
echo '<div class="res-box">File Foto Baru <b>'.$nama_file.'</b> Berhasil Di Upload.</div>';
echo '<div class="res-box"><img src="'._URLWEB.'up/rate/'.$dest_file.'" alt="file upload"></div>';
