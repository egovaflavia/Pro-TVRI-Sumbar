...
if (!$uploadfile) { 
	...
	$queryfoto = $akdb->dbquery("UPDATE "._TBBERITA." SET `foto`='".$dest_file."',`cfoto`='".$cname."' WHERE id_br=".$_POST['cid_br']."");
}	
//thumnailfoto

//tampilkan file hasil upload
echo '<div class="res-box">File Foto Baru <b>'.$nama_file.'</b> Berhasil Di Upload.</div>';
echo '<div class="res-box"><img src="'._URLWEB.'up/berita/'.$dest_file.'" alt="file upload"></div>';
