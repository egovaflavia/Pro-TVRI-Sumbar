      ...
      <div class="row">
        <div class="span12">
          ...
          if($act == 'tambah') {
            ...
            <div class="widget ">
              ...
              <div class="widget-header">
                ...
                <h3>Entry Mata Acara</h3>
              </div> <!-- /widget-header -->
          
                <div class="widget-content"> 

                <form id="entry" class="form-horizontal" action="<?=_URLWEB;?>admin.php?admin=apps&mod=event&act=simpan" method="post">
                  <fieldset>
                    ...
                    <div class="form-actions">
                      ...
                      <input name="Reset" type="reset" class="btn" value="Reset">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?=_URLWEB;?>admin.php?admin=apps&mod=event" class="btn btn-success">Kembali</a>
                    </div> <!-- /form-actions -->
                  </fieldset>
          ...
          <div class="widget ">
              ...
              <div class="widget-header">
                <i class="icon-pencil"></i>
                <h3>Edit Mata Acara : <?=$sqledit->tahun;?></h3>
              </div> <!-- /widget-header -->
          
              <div class="widget-content"> 

              <form id="edit" class="form-horizontal" action="<?=_URLWEB;?>admin.php?admin=apps&mod=event&act=update" method="post">
                  <fieldset>
          ...
          <div class="widget ">
              ...
              <div class="widget-header">
                <i class="icon-pencil"></i>
                <h3>Update Foto Mata Acara : <?=$sqledit->tahun;?></h3>
            </div> <!-- /widget-header -->
          
          <div class="widget-content"> 

          <form id="form-upload" class="form-horizontal" action="<?=_URLWEB;?>admin/prosesfotoevent.php" method="post" enctype="multipart/form-data" name="form-upload">
                      <fieldset>
                      
                      <div class="control-group">                     
                      <label class="control-label" for="fotokini">Foto Lama :</label>
                      <div class="controls">
                      <?php if($sqledit->foto <> '') { echo"<img src="._URLWEB."up/matacara/".$sqledit->foto." alt=foto>"; } else { echo"<img src="._URLWEB."img/no_foto_small.jpg border=0 alt=nofoto>"; } ?>
                      </div> <!-- /controls -->       
                      </div> <!-- /control-group -->
                ...
                <div><a href="<?=_URLWEB;?>admin.php?admin=apps&mod=event" class="btn btn-success">Kembali</a></div>
          ...
          ?>
            ...
            $targetpage = _URLWEB."admin.php?admin=apps&mod=event";  
            $limit = 5; 
            ...
            <div class="widget-content">
              <table class="table table-striped table-bordered">
                ...
                ?>
                  ...
                  ?>
                  <tr>
                    <td colspan="4">*Dihalaman front end hanya ditampilkan data mata acara <b>TAHUN TERBARU</b> dan fotonya telah di upload.</td>
            ...
            <!-- /widget-content -->
            <br />
            <div><a href="<?=_URLWEB;?>admin.php?admin=apps&mod=event&act=tambah"><button class="btn btn-github-alt"><i class="icon-plus-sign"></i> Entry Mata Acara</button></a></div>
            <br />
