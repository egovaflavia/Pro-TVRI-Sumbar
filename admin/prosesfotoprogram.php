...
if (!$uploadfile) { 
	...
	$queryfoto = $akdb->dbquery("UPDATE "._TBPROGRAM." SET `foto`='".$dest_file."',`cfoto`='".$cname."' WHERE id_pg=".$_POST['cid_pg']."");
}	
//thumnailfoto

//tampilkan file hasil upload
echo '<div class="res-box">File Foto Baru <b>'.$nama_file.'</b> Berhasil Di Upload.</div>';
echo '<div class="res-box"><img src="'._URLWEB.'up/program/'.$dest_file.'" alt="file upload"></div>';
