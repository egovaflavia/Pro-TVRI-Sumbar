...
if (!$uploadfile) { 
	...
	$queryfoto = $akdb->dbquery("UPDATE "._TBAGENDA." SET `foto`='".$dest_file."',`cfoto`='".$cname."' WHERE id_ag=".$_POST['cid_ag']."");
}	
//thumnailfoto

//tampilkan file hasil upload
echo '<div class="res-box">File Foto Baru <b>'.$nama_file.'</b> Berhasil Di Upload.</div>';
echo '<div class="res-box"><img src="'._URLWEB.'up/agenda/'.$dest_file.'" alt="file upload"></div>';
