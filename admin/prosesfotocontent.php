...
if (!$uploadfile) { 
	...
	$queryfoto = $akdb->dbquery("UPDATE "._TBKONTEN." SET `foto`='".$dest_file."' WHERE id_kt=".$_POST['cid_kt']."");
}	
//thumnailfoto

//tampilkan file hasil upload
echo '<div class="res-box">File Foto Baru <b>'.$nama_file.'</b> Berhasil Di Upload.</div>';
echo '<div class="res-box"><img src="'._URLWEB.'up/konten/'.$dest_file.'" alt="file upload"></div>';
