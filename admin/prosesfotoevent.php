...
if (!$uploadfile) { 
	...
	$queryfoto = $akdb->dbquery("UPDATE "._TBMATACARA." SET `foto`='".$dest_file."' WHERE id_ma=".$_POST['cid_ma']."");
}	
//thumnailfoto

//tampilkan file hasil upload
echo '<div class="res-box">File Foto Baru <b>'.$nama_file.'</b> Berhasil Di Upload.</div>';
echo '<div class="res-box"><img src="'._URLWEB.'up/matacara/'.$dest_file.'" alt="file upload"></div>';
