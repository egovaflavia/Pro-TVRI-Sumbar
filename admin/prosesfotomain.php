...
if (!$uploadfile) { 
	...
	$queryfoto = $akdb->dbquery("UPDATE "._TBUTAMA." SET `foto`='".$dest_file."' WHERE id_ut=".$_POST['cid_ut']."");
}	
//thumnailfoto

//tampilkan file hasil upload
echo '<div class="res-box">File Foto Baru <b>'.$nama_file.'</b> Berhasil Di Upload.</div>';
echo '<div class="res-box"><img src="'._URLWEB.'up/slider/'.$dest_file.'" alt="file upload"></div>';
