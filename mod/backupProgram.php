			...
			?>
				...
				<div id="box-home-b" style="height:1120px;">
					...
					?>
						...
						<li>
							<div class="kot-sub-px"><a href="<?php echo _URLWEB . "program/detil/$rowse->id_pg/" . strtolower(str_replace(" ", "-", $namase41)) . ".html"; ?>"><img src="<?= $imgse; ?>" width="192" height="192"></a>
								<p style="padding: 0px 8px 8px 8px;" class="judul-program-home" align="center"><a href="<?php echo _URLWEB . "program/detil/$rowse->id_pg/" . strtolower(str_replace(" ", "-", $namase41)) . ".html"; ?>"><?= substr($rowse->nama, 0, 45); ?></a></p>
							</div>
						</li>
			...
			?>
				...
				<div id="box-home-b" style="height:1350px;">
					...
					while ($rowqb = mysql_fetch_object($sql)) {
						...
						if ($rowqb->foto <> '') {
							$imgqb = _URLWEB . "up/program/" . $rowqb->cfoto;
						} else {
							$imgqb = _URLWEB . "img/thumb_no-img-program.jpg";
						}
					...
					?>
						...
						<li>
							<div class="kot-sub-p">
								<p style="padding: 8px 8px 0px 8px; font-size:12px; font-weight:bold;"><a href="<?php echo _URLWEB . "program/" . strtolower($rowqb->kat); ?>">Program <?= ucwords($rowqb->kat); ?> &raquo;</a></p><a href="<?php echo _URLWEB . "program/detil/$rowqb->id_pg/" . strtolower(str_replace(" ", "-", $nama41)) . ".html"; ?>"><img src="<?= $imgqb; ?>" width="192" height="192"></a>
								<p style="padding: 0px 8px 8px 8px;" class="judul-program-home" align="center"><a href="<?php echo _URLWEB . "program/detil/$rowqb->id_pg/" . strtolower(str_replace(" ", "-", $nama41)) . ".html"; ?>"><?= substr($rowqb->nama, 0, 45); ?></a></p>
							</div>
						</li>
