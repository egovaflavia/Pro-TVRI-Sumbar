...
elseif($se == 'Entertainment' OR $se == 'News' OR $se == 'Life And Culture' OR $se == 'Kid' OR $se == 'Sport') {

?>

<!-- box detil -->
<div id="box-home-b" style="height:1120px;">
<div class="judul-big-content"><span class="judul-mod bg-blue">Program <?=ucwords($se);?></span></div>
