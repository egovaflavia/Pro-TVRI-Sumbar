...
<body data-spy="scroll" data-target=".site-navbar-target" id="home-section">
              ...
              <div class="" data-aos="fade-up" data-aos-delay="">
                <div class="trainer">
                  ...
                  <div class="px-md-3">
                    ...
                    ?>
                    <h3 style="color: #<?= $warna ?>; font-weight: bold;"><?= $pecahProgram['nama'] ?></h3>
                    <h5 style="font-size: 15px; color: #<?= $warna ?>; font-weight: bold;"><?= $pecahProgram['kat'] ?></h5>
                ...
                <div class="" data-aos="fade-up" data-aos-delay="">
                  <div class="d-lg-flex blog-entry">
                    <div class="row">
                      <div class="col-md-12">
                        <figure class="">
                          <a href="<?php echo _URLWEB . "berita/detil/$rowterkini->id_br/" . strtolower(str_replace(" ", "-", $judul41)) . ".html"; ?>"><img style="width: 100%; height: 200px;" src="<?php echo _URLWEB . 'up/berita/' . $rowterkini->foto ?>" alt="Image" class="img-fluid"></a>
                        </figure>
                      </div>
                      <div class="col-md-12">
                        <div class="blog-entry-text">
                          <h3><a href="<?php echo _URLWEB . "berita/detil/$rowterkini->id_br/" . strtolower(str_replace(" ", "-", $judul41)) . ".html"; ?>"><?= $rowterkini->judul ?></a></h3>
                          ...
                          <p><a href="<?php echo _URLWEB . "berita/detil/$rowterkini->id_br/" . strtolower(str_replace(" ", "-", $judul41)) . ".html"; ?>">Read More..</a></p>
                        </div>
                      </div>
                    </div>
                  </div>
  ...
  <hr>
  <!-- SnapWidget -->
  <center><b>FOLLOW IG KAMI <a href="https://www.instagram.com/mediatamaweb/">@MEDIATAMAWEB</a></b></center><br>
  <!-- LightWidget WIDGET -->
  <script src="https://cdn.lightwidget.com/widgets/lightwidget.js"></script><iframe src="//lightwidget.com/widgets/bf8dc903296e59cf9576cd527e4ba795.html" scrolling="no" allowtransparency="true" class="lightwidget-widget" style="width:100%;border:0;overflow:hidden;"></iframe><br>
  <!-- End Instagram -->
