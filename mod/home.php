    ...
    <div class="flexslider">
        ...
        <li>
          ...
          <div class="flex-caption">
              <div class="caption_title_line"><h2><?php echo $rowslider->judul;?></h2><p><?php echo $rowslider->subjudul;?></p></div>
          </div>
        </li>
...
<div class="judul-mod-content"><span class="judul-mod bg-blue">PROGRAM ACARA</span></div>
  ...
  <div class="list_carousel">
      ...
      if($rowpa->foto <> '') { $imgpa = _URLWEB."up/program/".$rowpa->cfoto; } else { $imgpa = _URLWEB."img/thumb_no-img-program.jpg"; }
...
if($rowterkini->foto <> '') { $imgtkn = _URLWEB."up/berita/".$rowterkini->cfoto; } else { $imgtkn = _URLWEB."img/thumb_no-img-berita-bs.jpg"; }
