...
<!-- edited by zute from here-->
							...
							<div data-live="true"
							   ...
							   <video data-title="TVRI Sumatera Barat">
							        <source type="application/x-mpegurl" src="http://ott.tvri.go.id/Content/HLS/Live/Channel(TVRIsumbarpadang)/index.m3u8">
							   </video>
							</div>

						</div>

<!-- edited by zute to here-->
