...
<?php
		...
		if($sqldetilfoto->foto <> '') { $imgdetil = "<div id=\"foto-detil\" align=\"center\"><img src=\""._URLWEB."up/foto/".$sqldetilfoto->foto."\" class=\"img-konten\" alt=\"$sqldetilfoto->judul\"></div>"; } else { $imgdetil = ""; }
		...
		if (isset($sqlbdsblm->id_ft)) $seb = $sqlbdsblm->id_ft; else $seb = "";
		if($seb <> '') {
		...
		if (isset($sqlbdsdh->id_ft)) $ses = $sqlbdsdh->id_ft; else $ses = "";
		if($ses <> '') { 
