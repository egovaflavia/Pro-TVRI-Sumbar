...
<!-- box home live streaming -->
<div id="box-home-ls">
<p class="julive">Live Streaming</p>


<!-- edited by prihandono from here-->
                                                <div class="col_three_fourth portfolio-single-image">
							<div data-live="true"
							     data-ratio="0.75"
							     class="flowplayer fixed-controls" data-key="$286437594764971">
							   <video data-title="">
							        <source type="application/x-mpegurl" src="https://5bb648ab35ae7.streamlock.net/tvrisumbar/live/playlist.m3u8">
							   </video>
							</div>
...
<div id="box-home-a"><div class="judul-mod-content"><span class="judul-mod bg-blue">Informasi</span></div>
<?php include_once"bmkg/penyiar.php"; ?>
</div>
<div id="box-home-a"><div class=""></div>
<?php include_once"bmkg/talentaoke.php"; ?>
</div>
...
<!-- box home gempa -->
<div id="box-home-a">
<div class="judul-mod-content"><span class="judul-mod bg-blue">Sosial Media</span></div>
<?php include_once"bmkg/fb.php"; ?>
</div>

<!-- box home gempa -->
<div id="box-home-a">
<div class="judul-mod-content"><span class=""></span></div>
