...
<div id="navheader">
      ...
      <ul id="menu" class="clearfix">
         ...
         <li><a href="<?php echo _URLWEB;?>program">Program Acara</a>
            <ul>
               <li><a href="<?php echo _URLWEB;?>program/Entertainment">Entertainment</a></li>
               <li><a href="<?php echo _URLWEB;?>program/News">News</a></li>
               <li><a href="<?php echo _URLWEB;?>program/Life And Culture">Life And Culture</a></li>
               <li><a href="<?php echo _URLWEB;?>program/Kid">Kid</a></li>
               <li><a href="<?php echo _URLWEB;?>program/Sport">Sport</a></li>
            </ul>
         </li>   
         <li><a href="#">Rate Card</a>
            <ul>
               <li><a href="<?php echo _URLWEB;?>rate/program">Rate Program</a></li>
               <li><a href="<?php echo _URLWEB;?>rate/iklan">Rate Iklan</a></li>
            </ul>
         </li>
         <li><a href="<?php echo _URLWEB;?>agenda">Agenda Kegiatan</a></li>
         <li><a href="<?php echo _URLWEB;?>berita">Berita</a></li>
         <li><a href="<?php echo _URLWEB;?>foto">Galeri Foto</a></li>
      </ul>
