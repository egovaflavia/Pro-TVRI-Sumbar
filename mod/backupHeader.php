...
<head>
  ...
  <?php if ($profil->gv <> '') {
    echo "<meta name=\"google-site-verification\" content=\"$profil->gv\" />";
  } ?>
  ...
  <?php if ($profil->mv <> '') {
    echo "<meta name=\"msvalidate.01\" content=\"$profil->mv\" />";
  } ?>
  ...
  <?php if ($profil->fbid <> '') {
    echo "<meta property=\"fb:app_id\" content=\"$profil->fbid\" />";
  } ?>
  ...
  <link rel="stylesheet" href="<?php echo _URLWEB; ?>fonts/icomoon/style.css">
  <link rel="stylesheet" href="<?php echo _URLWEB; ?>css/bootstrap.min.css">
  <link rel="stylesheet" href="<?php echo _URLWEB; ?>css/jquery-ui.css">
  <link rel="stylesheet" href="<?php echo _URLWEB; ?>css/owl.carousel.min.css">
  <link rel="stylesheet" href="<?php echo _URLWEB; ?>css/owl.theme.default.min.css">
  <link rel="stylesheet" href="<?php echo _URLWEB; ?>css/owl.theme.default.min.css">
  <link rel="stylesheet" href="<?php echo _URLWEB; ?>css/jquery.fancybox.min.css">
  <link rel="stylesheet" href="<?php echo _URLWEB; ?>css/bootstrap-datepicker.css">
  <link rel="stylesheet" href="<?php echo _URLWEB; ?>fonts/flaticon/font/flaticon.css">
  <link rel="stylesheet" href="<?php echo _URLWEB; ?>css/aos.css">
  <link rel="stylesheet" href="<?php echo _URLWEB; ?>css/style.css">
  <!-- Css Mediatama -->
  ...
  <div id="header" align="center">
    <div id="headercontent">
      ...
      <div id="header-a">
        ...
        <div class="weblogo">
          <a href="<?php echo _URLWEB; ?>"><?php if ($profil->logo <> '') {
                                              echo "<img src=\"" . _URLWEB . "up/web/" . $profil->logo . "\" width=\"430\" height=\"70\" alt=\"\" border=\"0\" />";
                                            } else {
                                              echo "<img src=\"" . _URLWEB . "img/weblogo.gif\" width=\"430\" height=\"70\" alt=\"\" border=\"0\" />";
                                            } ?></a>
        </div>
      ...
      <div id="header-b">
        ...
        <div id="header-ba">
          <a href="<?php echo _URLWEB; ?>streaming"><img src="<?php echo _URLWEB; ?>img/ls.gif" width="153" height="40" alt="" border="0" /></a>
        </div>
        <div id="header-bb">
    ...
    <div id="menuheader" class="box-shadow">
      ...
      <div id="navheader">
        ...
        <ul id="menu" class="clearfix">
          ...
          <li><a href="#">RATE CARD</a>
            <ul>
              <li><a href="<?php echo _URLWEB; ?>rate/program">Rate Penyiaran</a></li>
              <li><a href="<?php echo _URLWEB; ?>rate/iklan">Rate Produksi</a></li>
            </ul>
          </li>
          <li><a href="<?php echo _URLWEB; ?>info">INFORMASI</a></li>
